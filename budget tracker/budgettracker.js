export default class BudgetTracker {
  ...
  static entryHtml() {
    ...
    <td><input type="text" class="input input-description" placeholder="Details..." /></td>
    ...
    <td>
        <button class="delete-entry">&#10005</button>
    </td>
  </tr>
    `;
  }
  ...
  addEntry(entry = {}) {
    ...
    row.querySelector(".input-date").value =
      entry.data || new Date().toISOString().replace(/T.*/, "");
